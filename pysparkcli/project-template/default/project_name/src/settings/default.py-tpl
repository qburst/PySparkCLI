"""
PySpark Settings for {{ project_name }}

Generated by 'pysparkcli [command] options' using Python {{ python_version }}.

For more information on this file, see
https://code.qburst.com/jinoj/pyspark-cli/{{ docs_version }}/topics/settings/
"""
import socket
